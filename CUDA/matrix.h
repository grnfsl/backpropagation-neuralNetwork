...
void mat_vect_mult(Mat* A, double* x, unsigned int x_size, double* tmp, int thread_count);
...
void vect_vect_sub(double *x, double *y, unsigned int size, double *error, int thread_count);
